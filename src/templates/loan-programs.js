...
const LoanProgramPage = ({data}) => {
  ...
  return (  
                        ...
                        { data.wpgraphql.page.loan_program.paymentOptionsBenefits.paymentOptions.map((item, i) => 
                            (
                                <li key={item.fieldGroupName+i}>
                                    <a onClick={showbenefitpopup} href="#" data-target="#paymentModal" data-title="Improve Cash Flow" data-content="Advertising payment options is a great way to set you apart from your competitors and produce more leads for your business.">
    ...
    <Paymentbenefitoption visiblity={visible} handleClose={hidebenefitpopup} />
  </Layout>
