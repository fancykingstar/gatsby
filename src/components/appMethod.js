							...
							<div class="row">
								<div class="col-md-6 col-lg-3 d-flex flex-column mb-md-5 mb-lg-0">
									<div class="border appMethod rounded">
										<img src="http://devgb.enerbank.com/wp-content/themes/enerbank/img/mobile-app.svg"></img>
								...
								<div class="col-md-6 col-lg-3 d-flex flex-column mb-md-5 mb-lg-0">
									<div class="border appMethod rounded">
										<img src="http://devgb.enerbank.com/wp-content/themes/enerbank/img/online-applications.svg"></img>
								...
								<div class="col-md-6 col-lg-3 d-flex flex-column">
									<div class="border appMethod rounded">
										<img src="http://devgb.enerbank.com/wp-content/themes/enerbank/img/loan-by-phone.svg"></img>
								...
								<div class="col-md-6 col-lg-3 d-flex flex-column">
									<div class="border appMethod rounded">
										<img src="http://devgb.enerbank.com/wp-content/themes/enerbank/img/contractor-management-system.svg"></img>
