				...
				<div className="modal_content">
					...
					<div className="p-4 p-sm-5">
						<div className="line-height-normal">
							...
							<div id="download">
				                <a href="https://apps.apple.com/us/app/enerbank-usa-partner-portal/id1501254896" target="_blank" class="mb-4 mb-md-0"><img src={apple_btn} alt="apple-store-btn" width="120" /></a> 
				                <a href="https://play.google.com/store/apps/details?id=com.enerbank.partnerportal" target="_blank" class="mb-4 mb-md-0 ml-3"><img src={google_btn} alt="google-play-btn" width="120" /></a>
				            </div>
						</div>
					</div>
