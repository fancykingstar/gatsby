					...
					<div className="modal_content">
						{props.popData.innerpagebanner.pagebanner.bannner && (
							<>
								...
								<div className="modal_banner banner_bg" style={{ backgroundImage: "url(" + props.popData.innerpagebanner.pagebanner.bannner.sourceUrl + ")" }} title="Dlealer resource Modal Banner" >
						...
						<div className="px-3 py-5 p-sm-5">
							<div className="line-height-normal text-center" dangerouslySetInnerHTML={{__html:props.popData.content}} />
							<div className="row">
